...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verMina = (CheckBox) findViewById(R.id.verMinas);
        reset = findViewById(R.id.resetear);

        reset.setOnClickListener(new ResetOyente(this));
        cantidad.setOnClickListener(new CrearOyente(this));
    }
    ...
    public void crearMinas(int numero) {
        ...
        verMina.setOnClickListener(new VerMinaOyente(this));
